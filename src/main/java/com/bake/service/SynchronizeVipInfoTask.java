...
public class SynchronizeVipInfoTask extends BaseTask{
    ...
    protected JsonArray getSubData(String time) {
        ...
        String sql = "select card_id,vip_name,mobile,DATE_FORMAT(oper_date, '%Y-%m-%d %H:%i:%s') as oper_date,branch_no  FROM "+Sysconfig.dbName+".t_rm_vip_info  where oper_date>'"+time+"'";
